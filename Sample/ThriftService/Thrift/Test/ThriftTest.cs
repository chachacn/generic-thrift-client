        ...
        try
        {
          ...
          if (Thing != null && __isset.thing) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (int _iter153 in Thing.Keys)
              {
                oprot.WriteI32(_iter153);
                oprot.WriteI32(Thing[_iter153]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (int _iter158 in Success.Keys)
                {
                  oprot.WriteI32(_iter158);
                  oprot.WriteI32(Success[_iter158]);
                }
                oprot.WriteMapEnd();
              }
              oprot.WriteFieldEnd();
        ...
        try
        {
          ...
          if (Thing != null && __isset.thing) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter163 in Thing.Keys)
              {
                oprot.WriteString(_iter163);
                oprot.WriteString(Thing[_iter163]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
                ...
                if (field.Type == TType.Set) {
                  {
                    ...
                    for( int _i170 = 0; _i170 < _set169.Count; ++_i170)
                    {
                      int _elem171;
                ...
                if (field.Type == TType.Set) {
                  {
                    ...
                    TSet _set173 = iprot.ReadSetBegin();
                    for( int _i174 = 0; _i174 < _set173.Count; ++_i174)
                    {
                      int _elem175;
                      _elem175 = iprot.ReadI32();
                      Success.Add(_elem175);
                    }
                    iprot.ReadSetEnd();
                  }
                } else { 
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (int _iter176 in Success)
                {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (int _iter184 in Success)
                {
                ...
                if (field.Type == TType.Map) {
                  {
                    ...
                    {
                      int _key187;
                      Dictionary<int, int> _val188;
                      _key187 = iprot.ReadI32();
                      {
                        _val188 = new Dictionary<int, int>();
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (int _iter193 in Success.Keys)
                {
                  oprot.WriteI32(_iter193);
                  {
                    oprot.WriteMapBegin(new TMap(TType.I32, TType.I32, Success[_iter193].Count));
                    foreach (int _iter194 in Success[_iter193].Keys)
                    {
                      oprot.WriteI32(_iter194);
                      oprot.WriteI32(Success[_iter193][_iter194]);
                    }
                    oprot.WriteMapEnd();
                  }
                }
                ...
                if (field.Type == TType.Map) {
                  {
                    ...
                    {
                      long _key197;
                      Dictionary<Numberz, Insanity> _val198;
                      _key197 = iprot.ReadI64();
                      {
                        _val198 = new Dictionary<Numberz, Insanity>();
                        TMap _map199 = iprot.ReadMapBegin();
                        for( int _i200 = 0; _i200 < _map199.Count; ++_i200)
                        {
                          Numberz _key201;
                          Insanity _val202;
                          _key201 = (Numberz)iprot.ReadI32();
                          _val202 = new Insanity();
                          _val202.Read(iprot);
                          _val198[_key201] = _val202;
                        }
                        iprot.ReadMapEnd();
                      }
                      Success[_key197] = _val198;
                    }
                    iprot.ReadMapEnd();
                  }
                } else { 
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (long _iter203 in Success.Keys)
                {
                  oprot.WriteI64(_iter203);
                  {
                    oprot.WriteMapBegin(new TMap(TType.I32, TType.Struct, Success[_iter203].Count));
                    foreach (Numberz _iter204 in Success[_iter203].Keys)
                    {
                      oprot.WriteI32((int)_iter204);
                      Success[_iter203][_iter204].Write(oprot);
                    }
                    oprot.WriteMapEnd();
                  }
                }
                ...
                if (field.Type == TType.Map) {
                  {
                    ...
                    for( int _i206 = 0; _i206 < _map205.Count; ++_i206)
                    {
                      short _key207;
                      string _val208;
                      _key207 = iprot.ReadI16();
                      _val208 = iprot.ReadString();
                      Arg3[_key207] = _val208;
                    }
                    iprot.ReadMapEnd();
                  }
                } else { 
        ...
        try
        {
          ...
          if (Arg3 != null && __isset.arg3) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (short _iter209 in Arg3.Keys)
              {
                oprot.WriteI16(_iter209);
                oprot.WriteString(Arg3[_iter209]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
